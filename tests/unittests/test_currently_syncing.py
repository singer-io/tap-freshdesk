...
from tap_freshdesk.sync import (update_currently_syncing,
                             get_ordered_stream_list)
...
class TestGetOrderedStreamList(unittest.TestCase):
    ...
    def test_currently_syncing_not_in_list(self):
        ...
        expected_list = ["agents", "companies", "conversations", "groups", "satisfaction_ratings", "tickets", "time_entries"]
    ...
    def test_for_interrupted_sync(self):
        ...
        expected_list = ["groups", "satisfaction_ratings", "tickets", "time_entries", "agents", "companies", "conversations"]
